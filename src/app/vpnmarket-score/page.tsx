  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-4 text-xs text-muted">
        Как часто обновляются данные: компонент «Надёжность» (доступность сайта) пересчитывается
        автоматически по расписанию, в реальном времени. Остальные компоненты — на данных
        провайдера (цена, скорость, платформы, теги) — обновляются вручную при редактировании
        карточки сервиса в каталоге, без фиксированного календарного графика.
      </p>
