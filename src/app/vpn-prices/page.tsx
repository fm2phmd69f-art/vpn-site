...
const FAQ = [
  {
    q: "Сколько стоит установка VPN?",
    a: "Сама «установка» — то есть скачивание и запуск приложения — бесплатна у всех сервисов. Платите вы не за установку, а за подписку на доступ к серверам провайдера: обычно от 1–3 $ в месяц при оплате за год вперёд у бюджетных сервисов и выше — у премиальных. Разовой платы «за установку» ни у одного провайдера в каталоге нет.",
  },
  {
